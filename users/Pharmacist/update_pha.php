...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $query = "UPDATE pharmacist SET pharmacist_name='$username', email='$email', address='$address', city='$city',
     postal_code='$postalCode', contact_number='$contactNumber', website='$website', 
     description='$description', latitude='$latitude', longitude='$longitude',
       opening_time='$openingTime', closing_time='$closingTime' WHERE user_id='$userId'";
