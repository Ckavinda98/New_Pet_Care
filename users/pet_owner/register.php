...
<main class="first-main">
    ...
    <section class="glass-1">
		<div class="Dashboard">
        <center>
				<h1 style="margin-bottom: 30px;  border:2px solid #9f2485; border-radius:10px; width: 50%; ">Notice</h1>
			</center>
		<ul>
  ...
  <section class="glass-2">
		<div class="Dashboard">
			<center>
				<h1 style="margin-bottom: 30px;  border:2px solid #9f2485; border-radius:10px; width: 50%; ">Register Busniess</h1>
			</center>
      ...
      <input type="hidden" name="user_id" value="<?php echo $user_id; ?>"><br>
				...
				<input name="registerid" type="text" id="inputusername" class="form-control" placeholder="Goverment Id" required autofocus><br>
				<label>Busniess Name:</label>
				<input name="name" type="text" id="inputPassword" class="form-control" placeholder="Name" required><br>
				...
				<input name="con_num" type="text" id="confirmPassword" class="form-control" placeholder="Contact Number" required autofocus><br>
				<label>Official Email:</label>
				<input name="email" type="email" id="inputEmail" class="form-control" placeholder="Email" required><br>
                <label>Location:</label>
				
                <input name="address" type="address" id="inputaddress" rows="5" class="form-control" placeholder="Location" required><br>
