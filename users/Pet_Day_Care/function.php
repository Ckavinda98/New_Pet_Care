...
if (isset($_POST['submit'])) {
  ...
  $Shop_name = mysqli_real_escape_string($db, $_POST['day_care_name']);
  ...
  $check_query = "SELECT * FROM pet_day_care WHERE day_care_name='$Shop_name' LIMIT 1";
  ...
  $sql = "INSERT INTO pet_day_care (day_care_name, address, city, postal_code, contact_number, 
